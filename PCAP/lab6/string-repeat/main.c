...
// Host data
 ...
 char* programSource;
    ...
    fclose( fp );
    //char str[100];
char A[100]; // Input array
  char *C=NULL; // Output array

fprintf(stdout,"ENTER THE STRING : ");
scanf("%s",A);
printf("Enter the number of times to repeat the string: ");
int rep;
scanf("%d",&rep);
n=strlen(A);
...
kernel = clCreateKernel(program, "stringManipulation", &status);
