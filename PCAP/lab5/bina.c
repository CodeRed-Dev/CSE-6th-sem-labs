...
fprintf(stdout,"ENTER THE NO. OF elements and elements");
scanf("%d",&n);
...
NULL,
NULL);
printf(" bl done %d",status);
// STEP 8: Create the kernel

cl_kernel kernel = NULL;
// Use clCreateKernel() to create a kernel from the
// vector addition function (named "vecadd")
kernel = clCreateKernel(program, "bina", &status);

printf(" kr done%d",status);
